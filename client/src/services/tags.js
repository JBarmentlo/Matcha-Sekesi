...
export const getAllTags = async (sekes_tokens) => {
	...
	let request = {
		url: "http://13.38.118.106:80/api/tags/getall", // should be replaced after going to production with domain url
		method: "get",
		headers: {
...
export const updateUserTags = async (sekes_tokens, tag_list) => {
	// console.log("Get all tags")
	let request = {
		url: "http://13.38.118.106:80/api/tags/update", // should be replaced after going to production with domain url
		method: "post",
		headers: {
			"Content-type"       : "application/json",
			"x-access-token"     : sekes_tokens.accessToken,

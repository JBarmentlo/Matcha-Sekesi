...
export const getMyNotifs = async (access_token, offset, limit) => {
	...
	let request = {
		url: "http://13.38.118.106:80/api/notif/getall", // should be replaced after going to production with domain url
		method: "post",
		headers: {
...
export const setSeenNotifs = async (access_token, notif_ids) => {
	...
	let request = {
		url: "http://13.38.118.106:80/api/notif/setseen", // should be replaced after going to production with domain url
		method: "post",
		headers: {
			"Content-type"       : "application/json",
			"x-access-token"     : access_token.accessToken,
...
export const deleteNotifs = async (access_token, id) => {
	...
	let request = {
		url: "http://13.38.118.106:80/api/notif/delete", // should be replaced after going to production with domain url
		method: "post",
		headers: {
			"Content-type"       : "application/json",
			"x-access-token"     : access_token.accessToken,
